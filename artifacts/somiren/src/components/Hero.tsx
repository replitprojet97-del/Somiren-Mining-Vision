    ...
    <section id="home" className="relative min-h-[90vh] flex items-center pt-24 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div
          ...
          style={{ backgroundImage: "linear-gradient(to right, rgba(0,0,0,0.95) 0%, rgba(0,0,0,0.85) 35%, rgba(0,0,0,0.5) 65%, rgba(0,0,0,0.2) 100%)" }}
        />
      ...
      <div className="container relative z-10 mx-auto px-4 md:px-8">
        ...
        >
          ...
          <motion.p
            variants={itemVariants}
            className="text-xl md:text-2xl text-white/95 mb-10 font-light drop-shadow-[0_2px_8px_rgba(0,0,0,0.6)]"
          >
